...
function poki_loadbar(ctx, width, height, total, current, image) {
    ...
    // get parameters:
    var backgroundColor = getc("background_color", "#79FEE7");
    var barBackgroundColor = getc("bar_background_color", "#79FEE7");
    var barForegroundColor = getc("bar_foreground_color", "#009CFF");
    var barBorderColor = getc("bar_border_color", "#002B50");
